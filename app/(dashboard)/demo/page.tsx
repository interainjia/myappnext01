...
export default function ModalDemoPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 space-y-10">
      <div>
        <h1 className="text-2xl font-bold text-slate-800">GlassModal Demo</h1>
        <p className="mt-1 text-sm text-slate-500">毛玻璃弹出框 · Framer Motion 弹簧动画</p>
      </div>
      ...
      >
        <div className="flex gap-4">
          ...
          <div>
            <p className="font-medium text-slate-800">Data export completed</p>
      ...
      >
        <div className="flex gap-4">
          ...
          <div>
            <p className="font-medium text-slate-800">Are you sure?</p>
            <p className="mt-1 text-slate-500">
              This action cannot be undone. All data associated with{' '}
              <span className="font-medium text-slate-700">Project Alpha</span>{' '}
      ...
      >
        <div className="space-y-4">
          <label className="block">
            <span className="text-xs font-medium text-slate-500 uppercase tracking-wide">Display Name</span>
            <input
              type="text"
              value={name}
          ...
          <label className="block">
            <span className="text-xs font-medium text-slate-500 uppercase tracking-wide">Bio</span>
            <textarea
              rows={3}
      ...
      >
        <div className="space-y-4 text-slate-600">
          {Array.from({ length: 6 }, (_, i) => (
            <div key={i}>
              <p className="font-medium text-slate-700">Section {i + 1}</p>
              <p>
